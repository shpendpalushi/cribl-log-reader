...
function backwardsStream(file: string,opts: any){
  ...
  s._readLoop = function (){
    ...
    (function fn(blockSize){
      ...
      read(s.fd,blockSize,pos,function(err: any,bytesRead: any,buf: any){
  ...
  function read(fd: any,size: any,pos: any,cb: any){
    reading = true;
...
export default backwardsStream;